...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gbdatabase', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\gbprojet\\MainBundle\\Entity'))), 'gbprojet\\MainBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('gbprojetMainBundle' => 'gbprojet\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aab01c23b101d20a21d10443b127c1da2496a4f552f3c2ee06d01ba6739192da');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('gbprojet\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('gbprojet\\MainBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.entity_manager'), 'gbprojet\\MainBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'gbprojetFrontBundle:Registration:email.html.twig', 'resetting' => 'gbprojetFrontBundle:Resetting:email.html.twig'), 'from_email' => array('confirmation' => array('mail@domain.tld' => 'name'), 'resetting' => array('mail@domain.tld' => 'name'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'gbprojet_fos_user_profile', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('gbprojet\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'gbprojet_fos_user_register', array(0 => 'Register', 1 => 'Default', 2 => 'Registration'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('gbprojet\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('gbprojet\\MainBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'gbprojet\\MainBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_BackofficeService()
    {
        ...
        $e = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, 'front_homepage'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $e->addHandler($this->get('security.logout.handler.session'));

        $f = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($a, array('login_path' => 'fos_user_security_login', 'use_referer' => true, 'default_target_path' => 'fos_user_profile_show', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
        $f->setProviderKey('backoffice');

        return $this->services['security.firewall.map.context.backoffice'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $e, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $a, 'backoffice', $f, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($c, $a, array('login_path' => 'fos_user_security_login', 'failure_path' => 'fos_user_security_check', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $d), array('use_forward' => true, 'check_path' => 'fos_user_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58f5467da92b0', $d), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'backoffice', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'fos_user_security_login', true), NULL, NULL, $d));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $e, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $a, 'main', $f, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($c, $a, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $d), array('use_forward' => true, 'check_path' => 'fos_user_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58f5467da92b0', $d), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'fos_user_security_login', true), NULL, NULL, $d));
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('backoffice', 'fos_user_security_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \JavierEguiluz\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension($this->get('easyadmin.config.manager'), $this->get('property_accessor'), true, NULL));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\gbprojet\\FrontBundle/Resources/views'), 'Front');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle/Resources/views'), 'EasyAdmin');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\gbprojet\\MainBundle/Resources/views'), 'gbprojetMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('224108646e54410ba805941931f7cb7c5e');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \gbprojet\FrontBundle\Form\Type\ProfileType A gbprojet\FrontBundle\Form\Type\ProfileType instance.
     */
    protected function getUser_Form_Profile_TypeService()
    {
        return $this->services['user.form.profile.type'] = new \gbprojet\FrontBundle\Form\Type\ProfileType('gbprojet\\MainBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \gbprojet\FrontBundle\Form\Type\RegisterType A gbprojet\FrontBundle\Form\Type\RegisterType instance.
     */
    protected function getUser_Form_Register_TypeService()
    {
        return $this->services['user.form.register.type'] = new \gbprojet\FrontBundle\Form\Type\RegisterType('gbprojet\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener($this->get('security.context'), array(0 => $this->get('fos_user.user_provider.username_email')), 'primary_auth', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FrontBundle' => 'gbprojet\\FrontBundle\\FrontBundle',
                'EasyAdminBundle' => 'JavierEguiluz\\Bundle\\EasyAdminBundle\\EasyAdminBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'gbprojetMainBundle' => 'gbprojet\\MainBundle\\gbprojetMainBundle',
            ...
            'locale' => 'en',
            'secret' => '224108646e54410ba805941931f7cb7c5e',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => '224108646e54410ba805941931f7cb7c5e',
            ...
            'easyadmin.config' => array(
                'entities' => array(
                    'User' => array(
                        'class' => 'gbprojet\\MainBundle\\Entity\\User',
                        'name' => 'User',
                    ),
                    'Groupe' => array(
                        'class' => 'gbprojet\\MainBundle\\Entity\\Groupe',
                        'name' => 'Groupe',
                    ),
                ),
                'design' => array(
            ...
            'fos_user.resetting.email.template' => 'gbprojetFrontBundle:Resetting:email.html.twig',
            'fos_user.registration.confirmation.template' => 'gbprojetFrontBundle:Registration:email.html.twig',
            'fos_user.storage' => 'orm',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'gbprojet\\MainBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'gbprojet_fos_user_profile',
            ...
            'fos_user.registration.form.type' => 'gbprojet_fos_user_register',
            ...
            'fos_user.model.group.class' => 'gbprojet\\MainBundle\\Entity\\Group',
