...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/profile')) {
            ...
            if ($pathinfo === '/profile/editer') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_fos_user_profile_edit;
                }

                return array (  '_controller' => 'FoulquierInfoFrontOfficeBundle:Profile:edit',  '_route' => 'fos_user_profile_edit',);
            }
            not_fos_user_profile_edit:

        }

        // gbprojet_main_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'gbprojet_main_default_index')), array (  '_controller' => 'gbprojet\\MainBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        // front_programmation
        if (0 === strpos($pathinfo, '/programmation') && preg_match('#^/programmation/(?P<grade>[^/\\-]++)\\-(?P<niveau>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // front_disponibilite
        if (0 === strpos($pathinfo, '/disponibilite') && preg_match('#^/disponibilite/(?P<app_ufr>[^/]+)ufr$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                // gbprojet_Front_security_login
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'gbprojetFrontBundle:Security:login',  '_route' => 'gbprojet_Front_security_login',);
                }

                // gbprojet_Front_security_check
                if ($pathinfo === '/login-check') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_gbprojet_Front_security_check;
                    }

                    return array (  '_controller' => 'gbprojetFrontBundle:Security:check',  '_route' => 'gbprojet_Front_security_check',);
                }
                not_gbprojet_Front_security_check:

            }

            // gbprojet_Front_security_logout
            if ($pathinfo === '/logout') {
                return array (  '_controller' => 'gbprojetFrontBundle:Security:logout',  '_route' => 'gbprojet_Front_security_logout',);
            }
